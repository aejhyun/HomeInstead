...
class OfficeTaskInformationTableViewCell: UITableViewCell {
    ...
    func setCell() {
        ...
        self.taskCommentTextView.layer.borderWidth = 1.0
        self.taskCommentTextView.layer.borderColor = UIColor.lightGrayColor().CGColor
        self.taskCommentTextView.layer.cornerRadius = 5.0
