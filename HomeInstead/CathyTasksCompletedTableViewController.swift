    ...
    override func viewDidLoad() {
        ...
        self.attemptQueryingTaskInformation(queryFromLocalDateStore: false) { (querySuccessful) -> Void in
            if querySuccessful {
                ...
                self.startedTimes = self.startedTimes.reverse()
                self.finishedTimes = self.finishedTimes.reverse()
                self.clientNames = self.clientNames.reverse()
                self.clientObjectIds = self.clientObjectIds.reverse()
                self.careGiverNames = self.careGiverNames.reverse()
                self.careGiverObjectIds = self.careGiverObjectIds.reverse()
                self.taskInformationObjectIds = self.taskInformationObjectIds.reverse()
